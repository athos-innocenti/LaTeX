...
\end{array}\right.
\end{equation*}
L'andamento della corrente $I_{d}$ è esattamente quello rappresentato dalle curve nel grafico di destra nelle tre figure precedenti. Questi grafici sono resi disponibili all'interno del datasheet del dispositivo.
...
La costante \textit{K} è definita come:
\begin{equation*}
...
\end{itemize}
Applicando una tensione $V_{gs}$ sul gate..
