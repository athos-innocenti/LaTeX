...
\subsection{Cutoff}
Nella regione di cutoff o di interdizione la tensione tra gate e source non ha ancora raggiunto il valore di soglia, cioè $V_{gt} < V_{t}$.
\begin{figure}[h]
    \centering
...
\begin{enumerate}
    \item Valutare il valore di k in base alle seguenti curve:
    \begin{figure}[h]
        \centering
       \includegraphics[scale=0.4,angle=0]{n_mos_es1.png}
    \end{figure}
    \\Ue uaiò bella sta curva
\end{enumerate}
\end{appendices}
\end{document}
