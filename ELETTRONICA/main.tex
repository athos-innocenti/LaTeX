...
\end{itemize}
Da tutti questi parametrici statici è ora possibile ricavare ulteriori grande d'interesse:
\begin{itemize}
...
\end{itemize}
Per quanto riguarda i parametrici dinamici si può dire che è un circuito abbastanza veloce 
