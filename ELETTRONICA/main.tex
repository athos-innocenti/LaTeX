...
\begin{itemize}
    ...
    abbastanza alto
    \begin{equation*}
        \textit{NM}_{L} = V_{iL} - V_{oL} = 0,6\,V - 0,2\,V
    \end{equation*}
...
\begin{itemize}
    ...
    \item All'interno dell'APD, quando $Q_3$ si spegne 
    \item
\end{itemize}
