...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4,angle=0]{latch_sr.png}
...
\newpage
Il latch SR, che come accennato costituisce l'elemento base del DFF, compare per bene tre volte all'interno della struttura che realizzare il DFF e che è riportata in figura \ref{dff_struttura}.
\begin{figure}[h]
    \centering
