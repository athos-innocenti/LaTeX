...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.4,angle=0]{flash_adc.png}
    \caption{Struttura di un flash ADC}
\end{figure}
\\I valori analogici di tensione generati dalla stringa di resistenze entrano negli ingressi positivi di alcuni compratori (uno per ciascun valore di tensione) che ricevono nel loro ingresso negativo la medesima tensione analogica $V_{a}$ che è la tensione che si vuole codificare.
